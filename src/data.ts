    ...
    subCategories: [
      {
        ...
        items: [
          ...
          { name: 'Delhi Chat' },
          { name: 'Chandni Chowk Chat' },
          { name: 'Aloo Tikki' },
          { name: 'Chole Samosa' },
          { name: 'Ragda Patties' },
          { name: 'Imrati Chat' },
          { name: 'Ghebar Chat' },
          { name: 'Bombay Chowpatty Bhel' },
          { name: 'Paneer Lakhnavi Tikki' },
          { name: 'Aloo Chat' },
          { name: 'Paneer Tikki' },
          { name: 'Makai Masti' },
          { name: 'Veg. Barbeque' },
          { name: 'Kumuri Palak Patta Chat' },
          { name: 'Banarasi Chat' },
          { name: 'Millennium Dry Fruit Chat' },
          { name: 'Pani Puri with Flavour' },
          { name: 'Patta Corn Basket' },
          { name: 'Crispy Aloo Chat' },
          { name: 'Dahi Bhalla Chat' },
          { name: 'Matka Dahi Wada' },
          { name: 'Cheella (Paneer / Moong / Spinach / Cheese)' },
          { name: 'Sev Puri' },
          { name: 'Bombay Bhel Chat' },
          { name: 'Idli Taka-Tak' },
          { name: 'Corn Tikki Chat' },
          { name: 'Ratalu Chat' },
          { name: 'Raj Kachori' },
          { name: 'Kela Tikki Chat' },
          { name: 'Dahi Gunjiya Chat' },
          { name: 'Rajasthani Sprouted Chat' },
          { name: 'Aloo Tikki Chhole' },
          { name: 'Tandoori Chat' },
          { name: 'Tawa Mathura Chat' },
          { name: 'Lachha Katori Chat' },
          { name: 'Butter Khasta Puri Chat' }
        ]
      },
      {
        name: 'South Indian',
        items: [
          ...
          { name: 'Idli (Boil, Roasted, Fried)' },
          { name: 'Mexican Idli' },
          { name: 'Mendu Vada' },
          { name: 'Indian Bhaji Dosa' },
          { name: 'Butter Military Dosa' },
          { name: 'Andhra Masala Dosa' },
          { name: 'Banglore Special Dosa' },
          { name: 'Madhurai Sandwich Dosa' },
          { name: 'Mini Dosa (Masala, Plain, Mysore)' },
          { name: 'Sambhar' },
          { name: 'Rasam' },
          { name: 'Amli Rice' },
          { name: 'Lemon Rice' },
          { name: 'Apam' },
          { name: 'Onion Istu' },
          { name: 'Madrasi Chutney' },
          { name: 'Malkapuri Chutney' },
          { name: 'Mysore Chutney' }
        ]
      }
    ]
    ...
    subCategories: [
      {
        name: 'Italian',
        items: [
          { name: 'Baked Macaroni with Cream' },
          { name: 'Baked Spaghetti with Pasta' },
          { name: 'Baked Stuffed Aubergine' },
          { name: 'Spinach Mushroom Lasagna' },
          { name: 'Baked Asparagus & Penne Pasta' },
          { name: 'Mushroom Cannelloni with Pepper' },
          { name: 'Baked Penne Pasta with Vegetable' },
          { name: 'Cottage Cheese Lasagne' },
          { name: 'Baked Corn Mushroom' },
          { name: 'Baked Vegetable Florentine' },
          { name: 'Baked Burmese Spaghetti' },
          { name: 'Baked Lajaniya' },
          { name: 'Baked Veg. Cannelloni' },
          { name: 'Terrain with Roasted Pepper Sauce' },
          { name: 'Mushroom Pie' },
          { name: 'Loaded Potatoes' },
          { name: 'Corn Souffle Pasta Platter' },
          { name: 'Italian Tavo' },
          { name: 'Potato Roasti' },
          { name: 'Cheese Corn Risotto' },
          { name: 'Rekle' },
          ...
          { name: 'Soft Base Pizza' },
          { name: 'Swiss Potato Roasty' },
          { name: 'Swiss Banana Roasty' },
          { name: 'Ravioli' }
        ]
      },
      {
        name: 'Mexican',
        items: [
          { name: 'Mexican Relonise' },
          { name: 'Mexican Barbeque' },
          { name: 'Mexican Bhel' },
          { name: 'Mexican Tostada' },
          { name: 'Mexican Pizza' },
          { name: 'Mexican Basket' },
          { name: 'Nachos with Salad' },
          { name: 'Mexican Curry' },
          { name: 'Mexican Rice' },
          { name: 'Enchiladas' },
          { name: 'Mexican Triyaback' },
          { name: 'Mexican Kasadia' },
          { name: 'Mexican Tikki' },
          { name: 'Mexican Hoch Poch' },
          { name: 'Mexican Tit-Bit' },
          { name: 'Mexican Quesadillas' },
          { name: 'Buritos Max' },
          { name: 'Mexican Feasta Bowl' },
          { name: 'Mexican Tako Toast' },
          { name: 'Mexican Roast Potato' }
        ]
      }
    ]
  },
